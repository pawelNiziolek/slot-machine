class Game {
  ...
  render(colors = ["linear-gradient(rgb(110, 110, 110), white, rgb(110, 110, 110)", "linear-gradient(rgb(110, 110, 110), white, rgb(110, 110, 110)", "linear-gradient(rgb(110, 110, 110), white, rgb(110, 110, 110)"], money = this.wallet.getWalletValue(), result = "", stats = [0, 0, 0], bid = 0, wonMoney = 0) {
  ...
  startGame() {
    ...
    this.render(colors, this.wallet.getWalletValue(), win, this.stats.addShowGameStatistics(), bid, wonMoney)
  }
}